...
/// Shared by the product grid and the cart rows so both read the same
/// image the same way (see `ProductModel`'s own header comment for why
/// [imagePath] takes priority).
