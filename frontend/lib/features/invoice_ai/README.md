...
AI invoice scanner: photograph a supplier invoice, review OCR + Gemini extracted line items, confirm into a purchase order. See docs/05_FEATURES.md § 6 and docs/16_AI_MODULE.md.
