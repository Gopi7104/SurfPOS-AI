...
/// One product row in the Product List — name, SKU, price, stock, category,
/// a [StatusChip] for [ProductModel.status], and a low-stock/out-of-stock
/// badge when applicable. Tapping opens Product Details.
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    StatusChip(label: product.status.label, tone: _statusTone),
