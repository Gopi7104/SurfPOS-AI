...
Each subfolder currently holds only a `.gitkeep` placeholder — no assets have been added yet. Do not commit large/unoptimized binaries; compress images and keep fonts to the weights actually used.
